<span id="20250112210623-y5r3g7o" style="display: none;"></span># 1 FastAPI应用基本结构
...
[13 响应状态码](#20250120144034-rp7qdzx)
...
​`HeroUpdate`​ 类使用该方法即 `HeroUpdate.model_dump()`​ 返回一个字典数据。
